...
targets = [
    ("https://en.wikipedia.org/wiki/Oort_cloud",           ["/wiki/Oort_cloud"]),
    ("https://en.wikipedia.org/wiki/Coronal_mass_ejection",["/wiki/Coronal_mass_ejection"]),
    ("https://en.wikipedia.org/wiki/Local_Bubble",         ["/wiki/Local_Bubble"]),
    ("https://en.wikipedia.org/wiki/Big_Bang",             ["/wiki/Big_Bang"]),
    ("https://en.wikipedia.org/wiki/Solar_wind",           ["/wiki/Solar_wind"]),
]
...
print(f"  Total: {sum(r['chunks'] or 0 for r in results)} chunks across {len(results)} pages")
