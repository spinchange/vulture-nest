...
targets = [
    ("https://science.nasa.gov/mission/parker-solar-probe/", ["/mission/parker-solar-probe/"]),
    ("https://science.nasa.gov/mission/webb/",               ["/mission/webb/"]),
]
...
for i, (url, include_paths) in enumerate(targets):
    ...
    try:
        crawl = server.execute_source_crawl(
            url=url, expected_pages=6, dry_run=False, human_approved=True,
