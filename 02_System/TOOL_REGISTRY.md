...
*   **Description:** Monitors the 01_Wiki folder for changes and automatically triggers a graph sync and portal compilation.
*   **Command:** `pwsh -NoProfile -ExecutionPolicy Bypass -File watch-wiki.ps1` 
*   **Inputs:** None
*   **Outputs:** None

---
*Generated by generate-tool-registry.ps1 on 2026-04-25 12:07:58*
