...
- **Conversational Structure**: Introduction of the `tool` role in messages and specialized tokens (e.g., `[TOOL_CALLS]`) to delimit actions in the stream.
...
- **Strategy vs. Real-time**: LLMs currently favor turn-based environments (e.g., Pokémon battles) due to inference latency constraints.
