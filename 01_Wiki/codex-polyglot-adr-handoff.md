...
- Tier-0 artifact: `00_Raw/vulture-mcp/` — a Rust MCP server over stdio.
...
- `00_Raw/workbench/` is TypeScript/Node and does **not** fit cleanly into any tier — the RFC leaves this open.
