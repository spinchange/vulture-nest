...
Secondary gaps: no learned representations (Software 2.0 critique), high ceremony overhead (YANP), Windows/[[powershell|PowerShell]] lock-in, no self-modification capability.
