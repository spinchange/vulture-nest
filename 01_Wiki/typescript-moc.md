...
status: active
type: permanent
aliases: [typescript-index, ts-map]
---
# TypeScript MOC
...
* [[typescript-everyday-types]]: Primitives, `any`, Unions, and Type Aliases vs Interfaces.
* [[typescript-narrowing]]: Techniques for refining types in control flow.
...
* [[typescript-type-operators]]: `keyof`, `typeof`, and indexed access types.
* [[typescript-conditional-types]]: Logic at the type level.
...
## Reference
* [[typescript-utility-types]]: `Partial`, `Pick`, `ReturnType`, and other built-in helpers.
* [[typescript-compiler-options]]: Common `tsconfig.json` configurations.
