...
\<Tabs\>  
  \<Tab title="TypeScript"\>  
    ...
    \`OAUTH\_CLIENT\_ID\` and \`OAUTH\_CLIENT\_SECRET\` are associated with the MCP server client we created earlier.
...
For comprehensive security guidance, including attack vectors, mitigation strategies, and implementation best practices, make sure to read through \[Security Best Practices\](/specification/draft/basic/security\_best\_practices). A few key issues are called out below.
...
\* \[Security Best Practices\](/specification/draft/basic/security\_best\_practices)  
