...
export const FeatureBadge \= ({feature}) \=\> {  
  const color \= FEATURE\_COLORS\[feature.split(" (")\[0\]\] || "gray";  
...
\<McpClient name="AgentAI" homepage="https://github.com/AdamStrojek/rust-agentai" supports="Tools"\>  
  ...
  \* \[Example of MCP Server integration\](https://github.com/AdamStrojek/rust-agentai/blob/master/examples/tools\_mcp.rs)  
\</McpClient\>
...
\<McpClient name="MCP Bundler for MacOS" homepage="https://mcp-bundler.maketry.xyz" supports="Resources, Prompts, Tools"\>  
  ...
  \* \[MCP Bundler in action (video)\](https://www.youtube.com/watch?v=CEHVSShw\_NU)  
\</McpClient\>
...
\<McpClient name="mcp-client-chatbot" homepage="https://github.com/cgoinglove/mcp-client-chatbot" supports="Tools"\>  
  ...
  \* Visual workflow builder that lets you create custom tools by chaining LLM nodes and MCP tools together. Published workflows become callable as \`@workflow\_name\` tools in chat, enabling complex multi-step automation sequences.  
\</McpClient\>
...
\<McpClient name="MCPOmni-Connect" homepage="https://github.com/Abiorh001/mcp\_omni\_connect" supports="Resources, Prompts, Tools, Sampling"\>  
...
\<McpClient name="Swarms" homepage="https://github.com/kyegomez/swarms" supports="Tools, Discovery"\>  
  ...
  \* \[Swarms MCP Integration Documentation\](https://docs.swarms.world/en/latest/swarms/tools/tools\_examples/)  
\</McpClient\>
